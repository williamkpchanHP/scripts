...
function assembleLongLine(keyElement) {
    // firstPart = keyElement.substring(0,8)
    lastPart = keyElement.substring(8)
    imgblk = ''
    for(loop = 1; loop < 16; loop++){
      imgblk = imgblk + '<img src="' + lineHeader + keyElement + '/' + lastPart + '-'+ loop + '.jpg">'
    }
  //console.log(imgblk)
//break
  return imgblk
