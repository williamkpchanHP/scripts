...
templateHead = readLines("templateXhamHead.txt")
templateTail = readLines("templateXhamTail.txt")
templateHead = gsub("xhamster_spizoo", paste0(titleName, length(wholePage)), templateHead)
templateHead = gsub("Total:  273", paste0("Total:  ", length(wholePage)), templateHead)
