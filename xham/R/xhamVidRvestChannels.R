...
url = paste0("https://xhamster.com/channels/", channelName, "/")
  ...
  if(lastLineNum>1){
    for (page in 2:lastLineNum){
     url = paste0("https://xhamster.com/channels/", channelName, "/", page)
...
theFilename = paste0(channelName, "Channel_xham.html")
