...
urlheader ="https://www.xvideos.com/?k="
urltail = "&p="
content = character()
...
collectContents <- function(thepage){
  ...
  keywords = gsub(' src=".*?"',' class="lazy"',keywords)
  keywords = gsub(' data-idcdn.*?>','>',keywords)
  keywords = gsub(' data-idcdn.*?>','>',keywords)
  keywords = gsub('href="/video','href="https://www.xvideos.com/video',keywords)
  content <<- c(content, keywords)  
}

####### entry point
output = askforKey()
urlheader = paste0(urlheader, output)
urlAddr = urlheader
