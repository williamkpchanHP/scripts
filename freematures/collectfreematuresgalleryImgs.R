...
typeName = readline("enter typeName: 1 site, 2 niche (1,2)")
if(typeName == 1){
  pageHeader = paste0("http://freematuresgallery.com/site/", titleName, "/?page=")
}else{
  pageHeader = paste0("http://freematuresgallery.com/niche/", titleName, "/?page=")
}
...
#collectLinks
totalPages = as.numeric(readline("enter totalPages: "))
addr = 1:totalPages
...
theFilename = paste0("FMG", titleName, ".txt")
sink(theFilename)
cat(wholePage, sep="\n")
sink()
cat(orange("file created! ", theFilename), "\n\n")
