...
pageHeader="http://www.pornhub.com/channels/"
pageTail="/videos?page="

wholePage = character()
titleName = readline(prompt="enter channel name: ")
totalPages = readline(prompt="enter total pages: ")
theFilename = paste0("pornhubChannels-", titleName, ".html")

# remember to remove &#9;
addr = 1:totalPages

className = ".wrap img, .wrap .duration, .title" # pornpic
